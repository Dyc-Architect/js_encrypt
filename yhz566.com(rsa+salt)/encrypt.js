...
function encrypt(username,password,code,vvccookie) {
    var str = "{\"username\":\"" + username + "\",\"loginpass\":\"" + password + "\",\"code\":\"" + code + "\",\"vvccookie\":\"" + vvccookie + "\"}"
    console.log(str)
    var jsondata = rsa_encrypt(str);
    return jsondata;
}
console.log(encrypt('dyc', '123456', '26c04229987766711b5b4a49986e1318', '84bee4d6b20977f21e8e9aa070c3b9da'))