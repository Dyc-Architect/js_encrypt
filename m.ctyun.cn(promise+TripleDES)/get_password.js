...
function Z(e) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : ""
              ...
              , i = t.padding
              , u = void 0 === i ? "Pkcs7" : i
              , d = C.a.enc["Utf8"].parse(n)
              , l = {
                mode: C.a.mode[o],
                padding: C.a.pad[u]
            }
              , s = C.a.TripleDES.encrypt(e, d, l);
            return s.toString()
        }

function encrypted(userName, word){
    var key = CryptoJS.enc.Utf8.parse(X(ue(userName)))
...
// console.log(encrypted('123456@163.com', "192837adg!"))
function comParam_seqCode() {
...
function comParam_signature() {
    var n = (new Date).getTime() - "-1107",t = "s54zv9bm1vd5czfujy6nnuxj1l4g2ny6", a = comParam_seqCode();
    l = aaa("8d81");
    s = aaa.n(l);
